    ...
    model(0)
{
    ...
    ui->lineEditCoinControlChange->setPlaceholderText(tr("Enter a Rodentcoin address (e.g. Per4HNAEfwYhBmGXcFP2Po1NpRUEiK8km2)"));
#endif
    ...
    QAction *clipboardNetAmountAction = new QAction(tr("Copy after fee"), this);
    ...
    connect(clipboardNetAmountAction, SIGNAL(triggered()), this, SLOT(coinControlClipboardNetAmount()));
...
void SendCoinsDialog::on_sendButton_clicked()
{
    ...
    foreach(const SendCoinsRecipient &rcp, recipients)
    {
        ...
        if(rcp.label.length() > 0)
          recipientElement.append(QString(" %1 <span style='font-size:8px;'>%2</span><br />").arg(GUIUtil::HtmlEscape(rcp.label), rcp.address));
        else
    ...
    case WalletModel::InvalidAddress:
        QMessageBox::warning(this, tr("Send"),
            tr("The receiving address is not valid, please check."),
    ...
    case WalletModel::AmountWithFeeExceedsBalance:
        QMessageBox::warning(this, tr("Send"),
            tr("The total exceeds your balance with the %1 transaction fee included.").
...
void SendCoinsDialog::setBalance(qint64 balance, qint64 unconfirmed, qint64 immature)
{
